= Module 6: Event-Driven Ansible - New Device Added Workflow
:icons: font
...
[NOTE]
====
In the next module, we will see how this workflow gets triggered automatically when we add a device to our site in NetBox. This demonstrates the power of Event-Driven Ansible!
====
