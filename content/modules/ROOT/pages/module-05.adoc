= Module 5: Event-Driven Ansible Playbooks
:icons: font
...
In this module, we will check two pre-created Job Templates that we will use as part of our Event-Driven Ansible actions. The Job Templates are the usual ones found in Automation Controller, but we are going to use them later in our Ansible Rulebook as the `action` condition.
...
In this module, you've verified that the required Job Templates are in place:
